...
function Specialities() {
    ...
    const deleteSerie = async (id) => {
        try {
            await axios.delete(`/specialites/delete/${id}`);
    ...
    return (
        <div>
            <Container fluid>
                ...
                <h2 className='mt-2'>Liste des Specialites</h2>
                <Button className='mt-2' color='success' tag={Link} to="/admin/specialities/save">Ajouter Specialite</Button>
